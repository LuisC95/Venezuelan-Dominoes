-- Añade 'match_stats' a get_game_state: manos jugadas, dominós, trancas y
-- capicúas de la partida entera. Lo necesita la pantalla de fin de partida
-- (etapa 6) y no había forma de derivarlo del estado que ya se devolvía.
--
-- Es un create or replace a propósito: conserva los grants que dejó
-- 20260903025802_lock_down_function_grants.sql. No hay función nueva que
-- blindar.
